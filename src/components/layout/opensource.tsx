    ...
    <section className="pb-16 sm:pb-32 px-6 lg:px-0 max-w-4xl mx-auto">
      <div className="space-y-5 max-w-2xl">
        ...
        <p className="text-base md:text-lg font-medium text-gray-600 dark:text-gray-400">
          I strongly believe open source is the future of software development.
          It could even be a compliance requirement in the future. Check it out
          on GitHub and star it if you like what I'm doing.
        </p>
