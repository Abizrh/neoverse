      ...
      children: [
          ...
          children: [
            {
              ...
              content: [
                ...
                " * k: move up",
                " * l: move right",
                " * ctrl + e: switch between file system and editor",
                " * ",
                "*/",
                "",
                "",
        ...
        },
        {
          ...
          content: [
            ...
            "╚═════╝ ╚═╝ ╚════╝ ╚═╝  ╚═╝ ╚═════╝  ╚═════╝  ",
            "                                               ",
            "This project was created based on my configurations and the knowledge I have gained from the Neovim. ",
            "I hope you find it useful and enjoyable. If you have any suggestions or feedback, please feel free to reach out to me. ",
            "Thank you for using it! ",
            "",
            "",
            "# Disclaimer ‼️",
            "◾ It just a playground of nvim itself and it won't do anything such as LSP, treesiter etc. But it would help u a lot to exercise ur hands on keyboard!",
          ],
        },
      ],
    },
